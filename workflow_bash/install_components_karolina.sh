...
mkdir -p opm-josh
cd opm-josh
bash ../opm-sources/build_zoltan.sh ${target_dir}/boost-install
bash ../opm-sources/build_dune.sh ${target_dir}/boost-install
bash ../opm-sources/build_opm_josh.sh ${target_dir}/boost-install
deactivate
